...
<input name="nick" type="hidden" value="<font color=red><hr size=1 color=red>Administrador</font color=red>">
...
<input name="nick" type="hidden" value="<font color=red>Administrador</font color=red>">
...
<input type="button" value="Reiniciar chat" onClick="javascript:reinic()">
